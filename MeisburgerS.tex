...
\title{Overview}
\bulpoint{Broad-ranging experience (6+ yrs) in open-source application development.}
...
{\xpcell{2016}{--}{present}{
        ...
        \xpbul{Perch team (post-acquisition) tasked to deliver video experiences for TV.}
}}
{\xpcell{2014}{--}{2016}{
...
{\xpcell{2012}{--}{2014}{
        ...
        \xpbul{Migrated server infrastructure to AWS.}
...
{\xpcell{2014}{}{}{
        ...
        \xpbul{Conducted code reviews, developed features and hardened platform security.}
...
\bulpoint{Python, JavaScript, AWK, Bash, Objective-C, jQuery, HTML/CSS}
\bulpoint{AWS, GNU/Linux, OS X, Docker, Ansible, Git, MongoDB, GStreamer, WebRTC, Nginx, \TeX{}}
\bulpoint{Familiar with: C, C++, GLib, Java, StatsD, Yocto Project}
