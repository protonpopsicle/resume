...
\font\sans = "Letter Gothic Std:mapping=tex-text" at 8 pt
\font\sansbigger = "Letter Gothic Std:mapping=tex-text" at 9 pt
\font\sansbiggerbold = "Letter Gothic Std/B:mapping=tex-text" at 9 pt
\font\sansbiggerbolditalic = "Letter Gothic Std/BI" at 10 pt
...
\def\bulpoint#1{\item{-}#1 \vskip .5\baselineskip}
...
\def\xprow#1{\line{#1} \vskip\baselineskip}
\def\xpcell#1#2#3#4{\date{#1}{#2}{#3} \xpbody{#4}}
\def\xpbody#1{\vtop{\hsize 6.5 in #1} \hskip .2 in}
\def\xptitle#1#2{{\sansbiggerbold\uppercase{#1} }{\sansbigger . #2} \vskip .4\baselineskip}
\def\xptitlelong#1#2{\leftline{\sansbiggerbold\uppercase{#1}} \vskip .2\baselineskip \leftline{\sansbigger #2} \vskip .8\baselineskip}
...
\leftline{\uppercase{Honolulu, HI -- open to remote, New York City, or San Francisco Bay Area relocation}}
\leftline{\uppercase{408.836.4502 | smeisburger@gmail.com | www.linkedin.com/in/scottmeisburger}}

\title{Overview}

Technology leader, software engineer and product development professional with experience building high-quality software products and infrastructure at startups and global corporations. Skilled at directing lean, high-functioning software teams on complex projects.

\title{Experience Highlights}
\bulpoint{At AT\&T, built and led full-stack teams transforming legacy business-critical applications; now drives Billing and Authorization target architecture across global teams. Skills: staffing, platform architecture, digital transformation, tech due diligence, change management, DevOps, application security.}
\bulpoint{At Samsung, coded major backend services to support launch of cloud-connected cameras. Managed engineering team for audio/video platform allowing Samsung home products to connect and stream media to SmartThings clients. Skills: IoT, multimedia, real-time applications, cloud, data security.}

\title{Experience}

\xprow
{\xpcell{2022}{--}{present}{
        \xptitlelong{AT\&T}{Director Technology-Product Development / Expert Software Engineering, Platform Architecture}
        \xpbul{Built and led full-stack teams modernizing mission-critical AT\&T Business platforms, improving security and delivery.}
        \xpbul{Own target architecture for Billing and Authorization, aligning global product, engineering and platform teams.}
        \xpbul{Review project architectures; facilitate tradeoffs, diagrams, platform standards and cross-team design alignment.}
        \xpbul{Served as calibrated hiring expert accountable for high-quality hiring decisions across engineering teams.}
        \xpbul{Mentored engineering leaders in 4 offices, providing technical oversight in full-stack development, DevOps and security.}
}}
\xprow
{\xpcell{2018}{--}{2022}{
...
\bulpoint{Python, JavaScript, Bash, C, React, HTML/CSS, microservice architecture, K8s, CI/CD}
\bulpoint{AWS, GNU/Linux, macOS, Git, Docker, Terraform, MariaDB, MongoDB, GStreamer, WebRTC, Nginx, Redis}
\bulpoint{Familiar with: C, C++, Java, RTSP, Make, \TeX{}}
